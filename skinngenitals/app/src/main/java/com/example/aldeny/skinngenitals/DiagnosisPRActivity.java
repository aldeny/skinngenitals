...
public class DiagnosisPRActivity extends AppCompatActivity {
    ...
    public boolean cekGejala[] = new boolean[52];
    public double bobotGejala[] = new double[52];
    public String namaPenyakit[] = new String[17];
    public ListPenyakit vektorGP[] = new ListPenyakit[52];
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_diagnosis_pr);
        ...
        namaPenyakit[13]="Servisitis Gonore";
        namaPenyakit[14]="Ulkus Mole";
        namaPenyakit[15]="Kandidosis Vulvovaginal";
        namaPenyakit[16]="Kondiloma Akuminata";
        ...
        dg2= (Button) findViewById(R.id.diagnosis2);
        ...
        dg2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent u = new Intent(DiagnosisPRActivity.this, HasilActivity.class);
                Bundle b = new Bundle();
